...
![](img/pres-symp-jun26/logo-quarto.png){fig-align="center" width=20%}
...
![Example from [EC910 lecture notes](https://neil-lloyd.github.io/warwick-ec910/handout-6.html)](img/pres-symp-jun26/screenshot-pdf-example.png){fig-align="center"}
...
graph export "img/pres-symp-jun26/stata_histogram.png", replace
```

![](img/pres-symp-jun26/stata_histogram.png){fig-align="center"}
...
![](img/pres-symp-jun26/screenshot-lecture-quarto.png){fig-align="center"}

### HTML slides

![](img/pres-symp-jun26/screenshot-lecture-slides.png){fig-align="center"}


### PDF notes
![](img/pres-symp-jun26/screenshot-lecture-notes.png){fig-align="center"}
:::
...
![](img/pres-symp-jun26/screenshot-website-example.png){fig-align="center" width=80%}
...
- Parcing settings to LaTeX can appears to be tricky! (I've not even tried, yet.)
...
- Coding with a markdown file requires the use of code blocks. 

  - Not *necessarily* how you want your students to engage with code. 

  - Can probably write a script to strip the code and create a .r/.py/.do script for your students to run.

  - For example, I created a script that turns multi-lingual html documents into separate language-specific PDFs: [https://neil-lloyd.github.io/digital-resources/](https://neil-lloyd.github.io/digital-resources/)
